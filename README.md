...
There will be a separate folder for each Project. Days on which no work is done on a project will get their own folder, in which, for example, Swift Playgrounds or notes will find a place.
